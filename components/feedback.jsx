...
import { fetchSuggestions, feedBack, getLang } from './API';

function FeedbackButtons() {
  const [showFeedbackMessage, setShowFeedbackMessage] = useState(false);

  // Function to send feedback to API and show feedback message
