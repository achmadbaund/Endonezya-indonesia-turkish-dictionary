  ...
  return (
    <div>
      <div class="bg-white mx-auto max-w-container px-4 sm:px-6 lg:flex lg:px-8">
        ...
        <div class="relative z-10 hidden select-none lg:flex">
            <div class="z-20 flex flex-col">
              <div class="relative pt-4">
                  <div class="absolute bottom-0 left-11 right-0 top-8"></div>
                  <div class="pointer-events-auto relative z-10 w-[10.1rem] text-[0.8125rem] leading-5 text-slate-700">
        ...
        <div 
          class="relative z-20 mx-auto max-w-[40rem] pt-12 lg:mx-0 lg:w-[40rem] lg:max-w-none lg:flex-none lg:pr-4 sm:pt-6"
        >
          ...
          <form 
            ...
            <div className="flex-col flex mt-0 sm:flex-row">
              <input
                className={`sm:ml-0 shadow-md rounded-md bg-white ring-1 ring-slate-900/10 hover:ring-slate-300 ${scrolling ? 'h-10' : 'h-12'} py-2 pl-4 sm:pl-6 w-full sm:w-full text-left leading-6 placeholder-slate-400 text-slate-900 text-lg sm:text-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2`}
                type="text"
                autoFocus
                value={value}
              ...
              >
                <img
                  ...
                  src="https://maxst.icons8.com/vue-static/icon/svg/search.svg"
                  alt="magnifier"
                />
                Search 
              </button>
